...
static RPCHelpMan loadwallet()
{
    return RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting reliquiaed will be"
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!descriptor) {
        ...
        if (!descriptor) {
            throw JSONRPCError(RPC_WALLET_ERROR, "descriptor still null. This is a bug in reliquiaed.");
        }
    }
